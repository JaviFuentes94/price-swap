...
if (typeof chrome === 'undefined' || !chrome.runtime) {
    console.warn('Price Swap: Extension context not available');
...
function convertPrice(priceInfo) {
    ...
    if (!chrome || !chrome.runtime || !chrome.runtime.sendMessage) {
        console.warn('Price Swap: Extension context invalidated. Please reload the page.');
        displayError('Extension disconnected. Please reload the page.');
        return;
    }
    ...
    chrome.runtime.sendMessage({
        ...
        if (chrome.runtime.lastError) {
            console.error('Price Swap:', chrome.runtime.lastError.message);
            displayError('Extension disconnected. Please reload the page.');
            return;
        }
